                ...
                <table width="100%" class="table table-hover table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>NO</th>
                            <th>TGL.KEGIATAN</th>
                            <th>NOMOR PERDA YANG DILANGGAR</th>
                            <th>JENIS PELANGGARAN PERDA</th>
                            <th>TINDAK LANJUT</th>
                            <th>PENGADILAN</th>
                            <th>STATUS PROSES</th>
                            <th>TGL. SIDANG TIPIRING</th>
                            <th>KET</th>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tambah Data Penegakan Peraturan Daerah</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3 row">
                                <label for="jeniskelamin" class="col-sm-2 col-form-label">Nomor Perda Yang Dilanggar</label>
                                <div class="col-sm-6">   
                            ...
                            <div class="mb-3 row">
                                <label for="jeniskelamin" class="col-sm-2 col-form-label">Tindak Lanjut</label>
                                <div class="col-sm-6">   
                                <select class="form-select form-select-sm mb-3" id="jeniskelamin" name="jeniskelamin" aria-label=".form-select-lg example">
                                    <option selected>Pilih</option>
                                </select>
                            ...
                            <div class="mb-3 row">
                                <label for="jeniskelamin" class="col-sm-2 col-form-label">Pengadilan</label>
                                <div class="col-sm-6">   
                                <select class="form-select form-select-sm mb-3" id="jeniskelamin" name="jeniskelamin" aria-label=".form-select-lg example">
                                    <option selected>Pilih</option>
                                </select>
                            ...
                            <div class="mb-3 row">
                                <label for="jeniskelamin" class="col-sm-2 col-form-label">Status Proses</label>
                                <div class="col-sm-6">   
                                <select class="form-select form-select-sm mb-3" id="jeniskelamin" name="jeniskelamin" aria-label=".form-select-lg example">
                                    <option selected>Pilih</option>
                                </select>
                            ...
                            <div class="mb-3 row">
                                <label for="kelurahan" class="col-sm-2 col-form-label">Tgl sidang Tipiring</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="kelurahan" name="kelurahan">
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form name="sdform" action="{{config('app.url')}}/datalinmas/store" id="formdata" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                <label for="kelurahan" class="col-sm-2 col-form-label">Tanggal Kegiatan</label>
                                <div class="col-sm-6">
                                    <input type="date" class="form-control" id="kelurahan" name="kelurahan">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="jeniskelamin" class="col-sm-2 col-form-label">Nomor Perda Yang Dilanggar</label>
