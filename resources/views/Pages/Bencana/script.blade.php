...
<script type="text/javascript">
  ...
  function tambahdata(){
      $.ajax({
                    url: "{{config('app.url')}}/bencana_kebakaran/store",
                    method: "POST",
                    headers: {
 ...
 function deletedata(objectid){
          Swal.fire({
                ...
                if (result.isConfirmed) {
                      $.ajax({
                            url: "{{config('app.url')}}/bencana_kebakaran/delete/"+objectid,
                            type: "GET",
  ...
  function getData(objectid){
    $("#modaledit").modal();
    $.ajax({
        url: "{{config('app.url')}}/bencana_kebakaran/getdata",
        type: "GET",
        data: {objectid: objectid},
        headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
     ...
     headers: {
      ...
      success:function(res){
        if(res.status == "success"){
          ...
          let jenisbencana = $('#jenibencana_edit').val(res.data.jenisbencana);
          let sifatbencana = $('#sifatbencana_edit').val(res.data.sifatbencana);
          let korbanmanusia = $('#korbanmanusia_edit').val(res.data.korbanmanusia);
          let korbanmateriil = $('#korbanmateriil_edit').val(res.data.korbanmateriil);
          let jenispertolongan = $('#jenispertolongan_edit').val(res.data.jenispertolongan);
...
$('#modaltambah').on('show.bs.modal', function(){
 ...
 function updateDataAjax(){
          ...
          let tanggalkegiatan = $('#tanggalkegiatan_edit').val();
          let waktu = $('#waktu_edit').val();
          let kabkota = $('#kabkota_edit').val();
          let kecamatan = $('#kecamatan_edit').val();
          let keldes = $('#keldes_edit').val();
          let jenisbencana = $('#jenisbencana_edit').val();
          let sifatbencana = $('#sifatbencana_edit').val();
          let korbanmanusia = $('#korbanmanusia_edit').val();
          let korbanmateriil = $('#korbanmateriil_edit').val();
          let jenispertolongan = $('#jenispertolongan_edit').val();
  ...
  $.ajax({
      url: "{{config('app.url')}}/bencana_kebakaran/update",
      method: "POST",
      headers: {
          'X-CSRF-TOKEN': '{{ csrf_token() }}'
      },
